...
public class TrainableNetwork extends Network {

  protected QuadraticCost costFn = new QuadraticCost();

  //initialise the neural network
  public TrainableNetwork(int... layers) {
    super(layers);
  }

  public TrainableNetwork(int[] layers, Matrix[] weights, Vector[] biases) {
